...
-- Add webhook call counter to organizations
ALTER TABLE public.organizations ADD COLUMN IF NOT EXISTS webhook_calls_count integer NOT NULL DEFAULT 0;

-- Update admin_get_global_stats to include webhook_calls_count
